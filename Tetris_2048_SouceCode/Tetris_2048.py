...
def columnsToCheck(tiles_to_place):
   columnsSet = set()
   for y in tiles_to_place:
      for tile in y:
         if tile != None:
            columnsSet.add(tile.position.x)
   return columnsSet

def rowsToCheck(tiles_to_place):
   rowSet = set()
   for x in tiles_to_place:
      for tile in x:
         if tile != None:
            rowSet.add(tile.position.y)
   return rowSet
